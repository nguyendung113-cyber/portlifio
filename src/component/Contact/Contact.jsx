...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    notify();
    emailjs
      .sendForm("service_nv7e5nb", "template_q20pdty", form.current, {
      ...
      <div data-bs-theme="dark">
        <div className=" tw-text-center tw-w-full">
          <div className=" tw-flex ">
            ...
            <h1 className="tw-text-4xl tw-w-[500px] tw-my-4 tw-text-white">
              Liên hệ
            </h1>
            <div className=" tw-border-solid tw-m-auto  tw-border-l tw-w-full ">
              <div className="border-solid border-1 tw-flex tw-items-center tw-border-yellow-200"></div>
        ...
        <div className="tw-flex tw-flex-wrap max-[600px]:tw-flex-col max-[600px]:tw-items-center max-[600px]:tw-gap-3 tw-justify-center tw-gap-3">
          <div className="tw-flex  tw-gap-4 tw-flex-col tw-justify-center">
            <div className="card tw-w-[400px] tw-mx-3">
              <div className="card-body tw-gap-2 tw-text-xl tw-flex tw-items-center">
                <ion-icon
                  name="mail-outline"
                  className="tw-mx-5 tw-text-xl"
                ></ion-icon>
          ...
          <div>
            <form
              className="tw-flex max-[600px]:tw-items-center tw-flex-col"
              ref={form}
              onSubmit={sendEmail}
            >
              <label className=" tw-text-white tw-text-xl">Name</label>
              <input
                className="tw-w-[500px] max-[600px]:tw-w-[400px] tw-text-white 
                        tw-bg-transparent placeholder:tw-text-slate-400 tw-text-xl tw-border tw-border-slate-200 tw-rounded-md tw-px-3 tw-py-2
                        tw-transition tw-duration-300 tw-ease focus:tw-outline-none focus:tw-border-slate-400 hover:tw-border-slate-300 tw-shadow-sm focus:tw-shadow"
                type="text"
                placeholder="Tên của bạn"
                name="user_name"
              />
              <label className=" tw-text-white tw-text-xl">Email</label>
              <input
                className="tw-w-[500px] max-[600px]:tw-w-[400px] tw-text-white 
                        tw-bg-transparent placeholder:tw-text-slate-400 tw-text-xl tw-border tw-border-slate-200 tw-rounded-md tw-px-3 tw-py-2
                        tw-transition tw-duration-300 tw-ease focus:tw-outline-none focus:tw-border-slate-400 hover:tw-border-slate-300 tw-shadow-sm focus:tw-shadow"
              ...
              />
              <label className=" tw-text-white  tw-text-xl">Message</label>
              <textarea
                className="tw-w-[500px] max-[600px]:tw-w-[400px] tw-text-white 
                        tw-bg-transparent placeholder:tw-text-slate-400 tw-text-xl tw-border tw-border-slate-200 tw-rounded-md tw-px-3 tw-py-2
                        tw-transition tw-duration-300 tw-ease focus:tw-outline-none focus:tw-border-slate-400 hover:tw-border-slate-300 tw-shadow-sm focus:tw-shadow"
